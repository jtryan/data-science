...
def complex_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        if passenger['Sex'] == 'female' \
                or (passenger['Age'] < 18 and passenger['Pclass'] == 1):

            predicted_survived += 1
            predictions[passenger_id] = 1
        else:
            predictions[passenger_id] = 0

    print 'Actual survived: ' + str(actual_survived)
    print 'Predicted survived: ' + str(predicted_survived)
